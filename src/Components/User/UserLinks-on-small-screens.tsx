...
const UserLinksOnSmallScreens = () => {
  ...
  return (
    <div className="flex-col space-y-4 m-4 mt-2 hidden max-[950px]:block">
      ...
      <div
        onClick={ClickLogout}
        className="flex mt-6 items-center justify-center text-red-500 cursor-pointer bg-white p-4 hover:bg-gray-100 rounded-md"
      >
...
export default UserLinksOnSmallScreens;
